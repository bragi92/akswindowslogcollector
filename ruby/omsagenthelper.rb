module OMSAgentHelperModule
  ...
  class OnboardingHelper
    ...
    def initialize
      ...
      @key_path = "E:/oms.key"
      @cert_path = "E:/oms.crt"
      @install_info = "/opt/installinfo.txt"
    end
    ...
    def heartbeat
      ...
      begin
        body_hb_xml = AgentTopologyRequestHandler.new.handle_request("/opt/osinfo.txt", "a19881c3-d1f5-4f10-81dd-5a9ea0fe009c", get_cert_server(@cert_path))
